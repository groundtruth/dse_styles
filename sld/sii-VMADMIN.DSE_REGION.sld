...
<StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml">
    <NamedLayer>
        <Name>sii:VMADMIN.DSE_REGION</Name>
...
<sld:UserStyle>
    ...
    <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
            ...
            <sld:LineSymbolizer>
                <sld:Stroke>
                    <sld:CssParameter name="stroke">#7D0552</sld:CssParameter>
                    <sld:CssParameter name="stroke-width">1.2</sld:CssParameter>
                </sld:Stroke>
            </sld:LineSymbolizer>
            <sld:TextSymbolizer>
                <sld:Label>
                    <ogc:PropertyName>DSE_REGION</ogc:PropertyName>
                </sld:Label>
                <sld:Font>
                ...
                <sld:Fill>
                    ...
                    <sld:CssParameter name="fill">#7D0552</sld:CssParameter>
                </sld:Fill>
