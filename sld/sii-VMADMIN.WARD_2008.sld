...
<StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml">
    <NamedLayer>
        <Name>sii:VMADMIN.WARD_2008</Name>
...
<sld:UserStyle>
    ...
    <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
            ...
            <sld:LineSymbolizer>
                <sld:Stroke>
                    <sld:CssParameter name="stroke">#A23BEC</sld:CssParameter>
                </sld:Stroke>
            </sld:LineSymbolizer>
            <sld:TextSymbolizer>
                <sld:Label>
                    <ogc:PropertyName>WARD_LABEL</ogc:PropertyName>
                </sld:Label>
                <sld:Font>
                ...
                <sld:Fill>
                    ...
                    <sld:CssParameter name="fill">#A23BEC</sld:CssParameter>
                </sld:Fill>
        ...
        <sld:Rule>
            ...
            <sld:TextSymbolizer>
                ...
                <sld:VendorOption name="autoWrap">140</sld:VendorOption>
