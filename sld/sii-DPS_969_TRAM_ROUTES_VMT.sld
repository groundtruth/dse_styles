...
<StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml">
    <NamedLayer>
        <Name>sii:RAEDATA.DPS_969_TRAM_ROUTES_VMT</Name>
        ...
        <sld:Rule>
            ...
            <sld:LineSymbolizer>
                <sld:Stroke>
                    ...
                    <sld:CssParameter name="stroke-width">4.8</sld:CssParameter>
                </sld:Stroke>
            </sld:LineSymbolizer>
            <sld:LineSymbolizer>
                <sld:Stroke>
                    <sld:CssParameter name="stroke">#70BF44</sld:CssParameter>
